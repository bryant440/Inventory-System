...
</table> </div> @section('script') <script> function myFunction() { window.print(); } </script>
@endsection

</body> </html> @endsection @section('script')